...
decision points throughout the program, but instead entirely composed
it?  This idea, pushed to the extreme, corresponds to framing MOSES as
an explicit form of reasoning, which is what we will explore in this
Section.  Before I begin, let me say that I am not necessarily
advocating for that approach, even though I like it and is probably
the approach I would take if I were to port MOSES to Hyperon myself.
It spite of that I also recognize that it has a number of drawbacks.
The main ones are
\begin{enumerate}
